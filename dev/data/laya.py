...
# -----------------------------------------------------------------------------
DATA_CACHE_DIR = os.path.join(os.path.dirname(__file__), "laya3.2")
...
def tokenize(model_desc):
    ...
    data_filename = os.path.join(DATA_CACHE_DIR, "merged_laya_3.2.txt")
    ...
    # save to file
    val_filename = os.path.join(DATA_CACHE_DIR, "laya_32_val.bin")
    train_filename = os.path.join(DATA_CACHE_DIR, "laya_32_train.bin")
